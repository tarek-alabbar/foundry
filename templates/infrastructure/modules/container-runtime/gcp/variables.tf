...
variable "resource_group_name" { type = string  description = "Maps to GCP: not used, kept for interface parity" }
...
variable "cpu"                 { type = string  default = "1"     description = "GCP vCPU count (1/2/4/8)" }
variable "memory"              { type = string  default = "512Mi" description = "GCP memory (128Mi..32Gi)" }
variable "env_vars"            { type = map(string)  default = {} }
variable "min_replicas"        { type = number  default = 0 }
variable "max_replicas"        { type = number  default = 3 }
variable "environment_id"      { type = string  description = "Maps to GCP: not used, kept for interface parity" }
variable "registry_server"     { type = string }
variable "registry_username"   { type = string  default = "_json_key" }
